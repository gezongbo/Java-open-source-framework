...
public class FirstAspect {
	...
	public Object around(ProceedingJoinPoint pjp) throws Throwable{
		System.out.println("增强代码...FirstAspect...around...前");
		Object obj=pjp.proceed();   //显示调用目标方法
		System.out.println("增强代码...FirstAspect...around...后");
	...
	public void afterReturning(JoinPoint jp,Object obj){
		...
		System.out.println("增强代码...后置通知..."+obj);
	}
	
	
	//定义一个异常通知执行的方法：只有在目标方法出现异常时才会执行异常通知
	public void afterThrowing(Throwable e){
		System.out.println("增强代码...异常通知..."+e);
	}
	
	
	//定义一个最终通知执行的方法
	public void after(){
		System.out.println("增强代码...最终通知...");
	}
